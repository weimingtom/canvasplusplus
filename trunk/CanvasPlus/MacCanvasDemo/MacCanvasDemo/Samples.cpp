...
void Sample5(CanvasPlus::Canvas& canvas)
{
    ...
    int textw = ctx.measureText(text).width;
    ctx.shadowOffsetX = 0;
    ctx.shadowOffsetY = 0;
...
{
    Context2D& ctx = canvas.getContext("2d");
    CanvasGradient lingrad = ctx.createLinearGradient(0, 10, 0, 10 + 130);
...
{
    Context2D& ctx = canvas.getContext("2d");
    CanvasGradient lingrad = ctx.createLinearGradient(10, 0, 130, 0);
...
{
    Context2D& ctx = canvas.getContext("2d");
    CanvasGradient lingrad = ctx.createLinearGradient(130, 0, 10, 0);
    lingrad.addColorStop(0, "rgb(255,0,0)");
    lingrad.addColorStop(1, "rgb(255,255,255)");
    ctx.fillStyle = lingrad;
    ctx.fillRect(10, 10, 130, 130);
...
{
    Context2D& ctx = canvas.getContext("2d");
    CanvasGradient lingrad = ctx.createLinearGradient(0, 10 + 130, 0, 10);
    lingrad.addColorStop(0, "rgb(255,0,0)");
    lingrad.addColorStop(1, "rgb(255,255,255)");
    ctx.fillStyle = lingrad;
    ctx.fillRect(10, 10, 130, 130);
